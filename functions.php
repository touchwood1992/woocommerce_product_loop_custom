...
add_filter( 'woocommerce_product_add_to_cart_text', function( $text ) {
	...
	if ( $product->is_type( 'variable' ) ) {
		$text = $product->is_purchasable() ? __( 'Add', 'woocommerce' ) : __( 'Read more', 'woocommerce' );
	}
	return $text;
}, 10 );

function show_extra_variations()
{
	?>
	<div>
		<h6>Toppings</h6> 
		<hr style='margin:0 0 2rem 0;'/>
		<p>Brown Sugar Pearls</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>Brown Sugar Jelly Pearl</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>Coconut Jelly</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>Passionfruit Boba Pop</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>Oreo Bits</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>Aloe Vera Cubes</p><p><input class='d-block' type="number" name="" id=""></p>
		<p>White Jelly Pearls</p><p><input class='d-block' type="number" name="" id=""></p>
	...
	<div style='margin-bottom:1rem'>
		...
		<hr style='margin:0;' />
		<p>
			<select name="" id="" class='sell d-block'>
...
add_action( 'woocommerce_before_add_to_cart_button', 'show_extra_variations' );

function get_pros_cb()
{
	...
	//echo json_encode(array('pp' => 'dsf'));
	die();
}
add_action( 'wp_ajax_get_pros', 'get_pros_cb' );
add_action( 'wp_ajax_nopriv_get_pros', 'get_pros_cb' );

//=======================================================
GET variation woocommerce order
//=======================================================
